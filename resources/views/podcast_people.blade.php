<x-app-layout>
    <!-- Displays a list of people from the peoples table -->
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8" style="margin-top: 10px">
        ...
        <div class='episode'>
            ...
            <p><span class="font-semibold">RSS:</span> <a href='/podcast/shows/{{ base64_encode($people['rss']) }}' target="_blank"> {{ $people['rss']}} </a></p>
            ...
            <a href="{{ route('person.showRequest', ['name' => base64_encode($people->name)]) }}">{{ $people->name }}</a>
            <br/>
        </div>
        @endforeach
